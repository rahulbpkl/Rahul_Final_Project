...
private enum rulesList{
	...
	public static void main(String[] args) throws Exception  {
		...
		File tempHtmlFile = new File("Template/index.html");
	     newHtmlFile = new File("output/Template/index.html");
	...
	/*	 if(!arg1.equals(Options.values().toString()))
        ...
        File htmlFile = new File("output/Template/index.html");
	...
	public static void outputfile(){
        ...
        public static void man() throws IOException{
    		...
    		BufferedReader br = new BufferedReader(new FileReader("config/man"));
    			try {
    			    StringBuilder sb = new StringBuilder();
	...
	public static void displayDirectoryContents(File dir) throws Exception {
		...
		try {
			...
			for (File file : files) {
				...
				if (file.isDirectory()&&dir.toString().equals("src")) {
